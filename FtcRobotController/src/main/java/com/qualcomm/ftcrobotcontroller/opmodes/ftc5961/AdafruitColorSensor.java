...
public class AdafruitColorSensor {
    ...
    public static final int ENABLE = 0x80 | 0x00;
    public static final byte ENABLE_PON = 0b1;
    public static final byte ENABLE_AEN = 0b10;
    public static final int CDATAL = 0x80 | 0x14;
    public static final int CDATAH = 0x80 | 0x15;
    public static final int RDATAL = 0x80 | 0x16;
    public static final int RDATAH = 0x80 | 0x17;
    public static final int GDATAL = 0x80 | 0x18;
    public static final int GDATAH = 0x80 | 0x19;
    public static final int BDATAL = 0x80 | 0x1A;
    public static final int BDATAH = 0x80 | 0x1B;
